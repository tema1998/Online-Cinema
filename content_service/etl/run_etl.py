...
def run_etl_indefinitely():
    ...
    etl_movies = ETL(index_manager_movies, extractor_movies, transformer_movies, loader_movies, configs.etl_state,
                     configs.batch, "movies")
    ...
    etl_genres = ETL(index_manager_genres, extractor_genres, transformer_genres, loader_genres, configs.etl_state,
                     configs.batch, "genres")
    ...
    etl_persons = ETL(index_manager_persons, extractor_persons, transformer_persons, loader_persons, configs.etl_state,
                      configs.batch, "persons")
