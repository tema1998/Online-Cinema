...
class Settings(BaseSettings):
    billing_project_name: str = os.getenv(
    ...
    auth_service_set_premium_user: str = os.getenv(
        "AUTH_SERVICE_SET_PREMIUM_HANDLER", "api/v1/premium/set-premium-status")
    ...
    billing_premium_subscription_success_queue: str = Field(
        'billing_premium_subscription_success_queue', alias='BILLING_PREMIUM_SUBSCRIPTION_SUCCESS_QUEUE')
    billing_premium_subscription_fail_queue: str = Field(
        'billing_premium_subscription_fail_queue', alias='BILLING_PREMIUM_SUBSCRIPTION_FAIL_QUEUE')
    billing_film_purchase_success_queue: str = Field(
        'billing_film_purchase_success_queue', alias='BILLING_FILM_PURCHASE_SUCCESS_QUEUE')
    billing_film_purchase_fail_queue: str = Field(
        'billing_film_purchase_fail_queue', alias='BILLING_FILM_PURCHASE_FAIL_QUEUE')

    billing_premium_subscription_success_dlq: str = Field(
        'billing_premium_subscription_success_dlq', alias='BILLING_PREMIUM_SUBSCRIPTION_SUCCESS_DLQ')
    billing_premium_subscription_fail_dlq: str = Field(
        'billing_premium_subscription_fail_dlq', alias='BILLING_PREMIUM_SUBSCRIPTION_FAIL_DLQ')
    billing_film_purchase_success_dlq: str = Field(
        'billing_film_purchase_success_dlq', alias='BILLING_FILM_PURCHASE_SUCCESS_DLQ')
    billing_film_purchase_fail_dlq: str = Field(
        'billing_film_purchase_fail_dlq', alias='BILLING_FILM_PURCHASE_FAIL_DLQ')
